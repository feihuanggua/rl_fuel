"""SAC Seq12: Large ARiADNE maps (40m max), 4m ray, fresh training.
...
def train_sac(args):
    ...
    print(f"[SEQ12] start={start_step}, total={args.total_steps}, 4m ray, 40m maps, lr={args.lr}", flush=True)
...
def main():
    parser = argparse.ArgumentParser(description="SAC Seq12: Large ARiADNE 4m ray")
    parser.add_argument("--save-dir", type=str, default="./fuel_rl_checkpoints/sac_seq12")
